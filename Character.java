...
public class Character extends JPanel implements ActionListener {
    ...
    CharacterRecord[] queryData = myDB.getCrData();
     ...
     public String[] chrOrderArrImg = new String[4];
     private int sourceId = 0;
     public int[] chrOrderArrVal = new int[4];
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (source == chraddToCart) {
            ...
            closePopup();
            chrOrderArrImg[counter] = queryData[sourceId].getCrImg();
            counter++;
        }
        if (counter == 4) {
    ...
    public String[] getChrOrderArrImg(String[] temp1)
    {
        for (int i = 0; i < chrOrderArrImg.length; i++)
        {
            temp1[i] = chrOrderArrImg[i];
        }
        return temp1;
    }
    
    public int[] getChrOrderArrVal()
    {
        return chrOrderArrVal.clone();
    }
}
