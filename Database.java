...
//String myConnectString = "jdbc:ucanaccess://C:/Users/Gauta/Downloads/SwampSimulator/ShrekSim.accdb"; // GAUTAM'S DB
//    String myConnectString = "jdbc:ucanaccess://C:/Users/epicm/OneDrive/Desktop/New folder/swampsimulator/ShrekSim.accdb"; // Nick's DB //   String myConnectString ="jdbc:ucanaccess:///Users/doug/Google Drive/College/IST-311_OOD-SoftwareDev/MasterContenderProject/SwampSimulator/ShrekSim.accdb"; // DOUG'S DB
    String myConnectString = "jdbc:ucanaccess://V:/Downloads/IST 311/SwampSimulator-master/SwampSimulator-master/ShrekSim.accdb";
    //Fall 2019/IST 311/project/New folder/swampsimulator/ShrekSim.accdb"; // CAM'S DB
...
//this method accepts the student data as input and stores it to the database 
    ...
    public void createAdOrderTable() {
       ...
       try
        {
         ...
         //this code may need to be commented out because an exception will be thrown
         //if this table doesn't exist in the database
         stmt.execute("DROP TABLE AdventureOrder");
         System.out.println("table dropped.");
         
         stmt.execute("CREATE TABLE AdventureOrder" +
                         "AdventureName varchar(255), " +
                         "AdventureImage varchar(255), " +
                         "AdventureValue number)");
       
         System.out.println("Created AdventureOrder table");
...
public void storeAdOrderRecord(String aName, String aImg, int aValue){
        ...
        try {
         ...
         Statement stmt = con.createStatement();
         //this Insert statement puts student info in the database
         stmt.executeUpdate("INSERT INTO AdventureOrder VALUES ("+aName+"','"+aImg+"','"+aValue+"')");
...
public void createCrOrderTable() {
       ...
       try
        {
         ...
         //this code may need to be commented out because an exception will be thrown
         //if this table doesn't exist in the database
         stmt.execute("DROP TABLE CharacterOrder");
         System.out.println("table dropped.");
         stmt.execute("CREATE TABLE CharacterOrder" +
                         "CharacterName varchar(255), " +
                        "CharacterImage varchar(255), " +
                         "CharacterValue number)");
       
         System.out.println("Created CharacterOrder table");
...
public void storeCrOrderRecord(String cName, String cImg, int cValue){
        ...
        try {
         ...
         Statement stmt = con.createStatement();
         //this Insert statement puts student info in the database
         stmt.executeUpdate("INSERT INTO CharacterOrder VALUES ("+cName+"','"+cImg+"','"+cValue+"')");
